package com.ul.ts.products.mdllibrary;
...
public final class HexStrings
{
     ...
     *          if the value cannot be represented by the specified number of bytes.
     */
    public static String longToHexWord(long value, int length)
    {
    ...
    public static String toHexString(int[] value, int wordLength)
    {
        StringBuffer buffer = new StringBuffer();
     ...
     */
    public static byte[] fromUnspacedHexString(String unspacedHexString) throws NumberFormatException
    {
     ...
     * @return a string representation of the byte array.
     */
    public static String toUnspacedHexString(byte[] value)
    {
